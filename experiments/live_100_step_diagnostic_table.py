...
LIVE_DIAGNOSTIC_COLUMNS: tuple[LiveDiagnosticColumn, ...] = (
    ...
    LiveDiagnosticColumn(
        "alpha_next",
        "a_next",
        ("alpha_next", "alpha_target", "target_alpha"),
        4,
    ),
    LiveDiagnosticColumn("alpha_delta", "a_delta", ("alpha_delta",), 4),
    LiveDiagnosticColumn("geo_to_qk_ratio", "geo_qk", ("geo_to_qk_ratio",), 4),
    LiveDiagnosticColumn(
        "memory_eta",
        "eta",
        ("memory_eta", "memory_eta_next", "current_memory_eta"),
        4,
    ),
    LiveDiagnosticColumn(
        "memory_eta_delta",
    ...
    LiveDiagnosticColumn(
        "memory_decay",
        "decay",
        ("memory_decay", "memory_decay_next", "current_memory_decay"),
        4,
    ),
    LiveDiagnosticColumn(
        "memory_decay_delta",
    ...
    LiveDiagnosticColumn(
        "gate_floor",
        "gate",
        ("gate_floor", "gate_floor_next", "current_gate_floor"),
        4,
    ),
    LiveDiagnosticColumn(
        "gate_floor_delta",
    ...
    LiveDiagnosticColumn(
        "distance_norm_scale",
        "norm",
        ("distance_norm_scale", "distance_norm_scale_next", "current_distance_norm_scale"),
        4,
    ),
    LiveDiagnosticColumn(
