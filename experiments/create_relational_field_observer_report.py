"""Create the Phase 2 Relational Field Observer report."""
...
from evaluation.relational_field_observer import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create ERGT relational field observer report.")
    parser.add_argument(
        "--config",
        type=Path,
        default=None,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("runs/observers/relational_field_observer_report.json"),
        help="Output path for relational_field_observer_report.json.",
    )
