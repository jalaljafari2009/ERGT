"""Create the Phase 3 Resonant-Response Observer report."""
...
from evaluation.resonant_response_observer import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create ERGT resonant-response observer report.")
    parser.add_argument(
        "--config",
        type=Path,
        default=None,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("runs/observers/resonant_response_observer_report.json"),
        help="Output path for resonant_response_observer_report.json.",
    )
